...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="ms-5 me-4 nav-link navi fs-4 " href="../index.php#carousel_promo">Promo</a>
        </li>
        <li class="nav-item">
          <a class="ms-5 me-4 nav-link navi fs-4" href="index.php">Gallery</a>
        </li>
        <li class="nav-item">
     ...
     <h1 class="p-5 navi">GALLERY</h1>
     <h3 class="navi text-center">Haircut</h3>
...
<h3 class="mt-5 navi text-center">Face Treatment</h3>
<section id="gal_car_1">
...
<h3 class="mt-5 navi text-center">Eye Treatment</h3>
<section id="gal_car_1">
